...
function loadPictures(ctx, next) {
  request.get('/api/pictures').end(function (error, res) {
...
module.exports = function (restaurants) {
  var element = yo(_templateObject, onsubmit, translate('upload-picture'), onchange, translate('upload'), cancel, restaurants.map(function (pic) {
    return picture(pic);
  }));
  ...
  function onsubmit(event) {
    ...
    request.post('/api/restaurants').send(data).end(function (error, res) {
...
},{"../translate":356,"yo-yo":340}],349:[function(require,module,exports){
'use strict';
...
},{"./template":351,"empty-element":300,"page":328}],351:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    'english': 'English',
    'spanish': 'Spanish',
    'signup.subheading': 'Signup to watch your friends pictures on Platzi',
    ...
    'signup.have-account': 'All ready have an account?',
    'signin': 'Login',
    'signin.not-have-account': 'Not having an account?',
    'language': 'Language',
    'upload': 'Upload',
